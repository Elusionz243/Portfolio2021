        ...
        <div className='card hp-card'>
          ...
          <div className='card-body introduction'>
            <p style={{ color: 'white' }}>
              ...
              I graduated from <a href="https://thinkful.com/" className='intro-links' target='_blank'>Thinkful</a> in May 2021,
              where I learned the majority of my web development skills. I'm currently a freelance web developer residing
              in <a href='https://goo.gl/maps/tcZyJZZWkiJvMaC97' className='intro-links' target='_blank'>San Antonio, Texas</a>.
            </p>
          </div>
        </div>
      </div> 
